...
'''
mask = mask_blue1 + mask_red1 + mask_red2

output_hsv = img_hsv.copy()
output_hsv[np.where(mask==0)] = 0
my.plt.figure(6)
my.display_image('TRAIN_output_hsv', output_hsv)
...
my.plt.figure(8)
my.display_image('TRAIN_img_result', img_result)

#--------------------------
# formiranje grayscale slike
img_grayscale = my.image_gray((img_result))
my.plt.figure(2)
my.display_image('TRAIN_Formiranje grayscale slike', img_grayscale)

# formiranje binarne slike
img_bin = my.image_bin(img_grayscale)
my.plt.figure(3)
my.display_image('TRAIN_Formiranje binarne slike', img_bin)

# uklanjanje šuma sa binarne slike
img_no_noise = my.invert(my.remove_noise(img_bin))
my.plt.figure(4)
my.display_image('TRAIN_img_bin sa remove_noise', img_no_noise)
#--------------------------
...
my.plt.figure(9)
my.display_image('TRAIN_img_selected_regions', img_selected_regions)
