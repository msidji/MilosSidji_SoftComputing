...
img_path = 'images_test/stop11.jpg'

# ucitavanje digitalne slike
img_color = my.load_image(img_path)
my.plt.figure(1)
my.display_image('PREDICT_Ucitavanje digitalne slike', img_color)

# ucitavanje hsv slikes
img_hsv = my.load_imageHSV(img_path)
my.plt.figure(5)
my.display_image('PREDICT_img_hsv', img_hsv)
...
my.plt.figure(6)
my.display_image('PREDICT_output_hsv', output_hsv)
...
my.plt.figure(8)
my.display_image('PREDICT_img_result', img_result)

#--------------------------
# formiranje grayscale slike
img_grayscale = my.image_gray((img_result))
my.plt.figure(2)
my.display_image('PREDICT_Formiranje grayscale slike', img_grayscale)

# formiranje binarne slike
img_bin = my.image_bin(img_grayscale)
my.plt.figure(3)
my.display_image('PREDICT_Formiranje binarne slike', img_bin)

# uklanjanje šuma sa binarne slike
img_no_noise = my.invert(my.remove_noise(img_bin))
my.plt.figure(4)
my.display_image('PREDICT_img_bin sa remove_noise', img_no_noise)
#--------------------------
...
my.plt.figure(9)
my.display_image('PREDICT_img_selected_regions', img_selected_regions)
